...
// console.log(state);
const Storecombine = (0, _redux.combineReducers)({
...
let store = (0, _redux.createStore)(Storecombine, window.__REDUX_DEVTOOLS_EXTENSION__?.());
store.subscribe(()=>{
...
store.dispatch((0, _cartReducer.addItem)(2));
store.dispatch((0, _cartReducer.increseItemCart)(2));
store.dispatch((0, _cartReducer.decreseItemCart)(2));
store.dispatch((0, _cartReducer.removeItem)(2));
store.dispatch((0, _wishListReducer.addWishList)(2));
store.dispatch((0, _wishListReducer.addWishList)(3));
store.dispatch((0, _wishListReducer.removeWishList)(3));

},{"redux":"anWnS","./ProductReducer":"81dMh","./CartReducer":"jxRUB","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./WishListReducer":"5bOYX"}],"anWnS":[function(require,module,exports) {
...
},{}],"81dMh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _productList = require("./ProductList");
const ProductReducer = (state = (0, _productList.ProductList), action)=>{
    return state;
};
exports.default = ProductReducer;

},{"./ProductList":"6DoqY","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6DoqY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jxRUB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ADD_ITEM_CART", ()=>ADD_ITEM_CART);
parcelHelpers.export(exports, "REMOVE_ITEM_CART", ()=>REMOVE_ITEM_CART);
parcelHelpers.export(exports, "INCRESE_ITEM_CART", ()=>INCRESE_ITEM_CART);
parcelHelpers.export(exports, "DECRESE_ITEM_CART", ()=>DECRESE_ITEM_CART);
parcelHelpers.export(exports, "addItem", ()=>addItem);
parcelHelpers.export(exports, "removeItem", ()=>removeItem);
parcelHelpers.export(exports, "increseItemCart", ()=>increseItemCart);
parcelHelpers.export(exports, "decreseItemCart", ()=>decreseItemCart);
const ADD_ITEM_CART = "cart/addItem";
const REMOVE_ITEM_CART = "cart/removeItem";
const INCRESE_ITEM_CART = "cart/increseItem";
const DECRESE_ITEM_CART = "cart/decreseItem";
...
function increseItemCart(productId) {
    return {
        type: INCRESE_ITEM_CART,
        payload: {
            productId
        }
    };
}
function decreseItemCart(productId) {
    return {
        type: DECRESE_ITEM_CART,
        payload: {
            productId
        }
    };
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5bOYX":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ADD_ITEM_WISHLIST", ()=>ADD_ITEM_WISHLIST);
parcelHelpers.export(exports, "REMOVE_ITEM_WISHLIST", ()=>REMOVE_ITEM_WISHLIST);
parcelHelpers.export(exports, "addWishList", ()=>addWishList);
parcelHelpers.export(exports, "removeWishList", ()=>removeWishList);
const ADD_ITEM_WISHLIST = "wishList/addItem";
const REMOVE_ITEM_WISHLIST = "wishList/removeItem";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire2d1f")
